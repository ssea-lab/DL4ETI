...
def Network_config(class_num=4, epoch=200, initial_epoch=0, batch_size=32,
    ...
    early_stopper = EarlyStopping(monitor='val_categorical_accuracy', min_delta=1e-4, patience=200)
...
def main():
    data = creat_list('binary_random_list.txt',class_num = 2)
    cross_validation(data, K=10, epoch=200, class_num=2, batch_size=32)
main()
